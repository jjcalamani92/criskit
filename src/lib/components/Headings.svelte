<script>
	import { formAdd, formUpdate } from "../stores";
  ...
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div class="lg:flex lg:items-center lg:justify-between">
        <div class="min-w-0 flex-1">
          <div class="flex space-x-3">
            ...
            <span class="hidden sm:block">
              <button on:click={formUpdate.toggle} type="button" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        ...
        <div class="mt-5 flex lg:ml-4 lg:mt-0">
          ...
          <span class="sm:ml-3">
            <button on:click={formAdd.toggle} type="button" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
